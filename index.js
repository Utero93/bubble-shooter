...
class Enemy {
    ...
    draw() {
        ...
        if (this.shape === 'circle') {
            ...
            // Draw an octagon
            let angle = Math.PI / 4;
            c.moveTo(this.x + this.radius * Math.cos(0), this.y + this.radius * Math.sin(0));

            for (let i = 1; i < 8; i++) {
                c.lineTo(this.x + this.radius * Math.cos(angle * i), this.y + this.radius * Math.sin(angle * i));
            }

            // draw a rectangle shape enemy
        } else if (this.shape === 'rectangle') {
            // Draw a rectangle
            c.rect(this.x - this.radius, this.y - this.radius / 2, this.radius, this.radius / 2);
            ...
            // Draw the boss shape
            c.fillStyle = 'blue';
            c.fillRect(this.x - this.radius, this.y - this.radius, this.radius * 2, this.radius * 4);
            ...
            c.beginPath();
            c.arc(this.x - this.radius * 0.4, this.y - this.radius * 0.3, this.radius * 0.2, 0, Math.PI * 2);
            c.fillStyle = 'white';
            c.fill();
            ...
            c.beginPath();
            c.arc(this.x, this.y + this.radius * 0.5, this.radius * 0.4, Math.PI * 0.2, Math.PI * 0.8);
            c.strokeStyle = 'black';
...
function spawnEnemies() {
    setInterval(() => {
        ...
        const shapes = ['circle', 'square', 'triangle', 'octagon', 'rectangle', 'trapezoid', 'boss1', 'boss2', 'boss3', 'boss4'];
